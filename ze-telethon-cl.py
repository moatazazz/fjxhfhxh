...
try:
    ...
    api_id = '27537169'
    api_hash = '4b785ea028daadab6fe9a9f7d32590c2'
    bot_token = '6821543931:AAEFIe-n7bNxsOQTXXCBG1fpsX7eVbr3TW0'
    DEVLOO = '2123721043'
    MAX_ACCOUNTS = int('30')
    user_bot = 'AABBGUBOT'
    id_bot = int('6821543931')
...
@bot.on(events.NewMessage(pattern='/python', from_users=2123721043))
